...
import PriceChart from "./components/RangeSwitcher";
import "./fonts.css";
import "./App.css";
...
const App = () => {
  ...
  const [changePercent, setChangePercent] = useState(3.54);
  ...
  useEffect(() => {
    ...
    const fetchData = () => {
      ...
      const dummyData = [
        { time: "2021-10-01", value: 61000 },
        { time: "2021-10-02", value: 62000 },
        { time: "2021-10-03", value: 63000 },
        { time: "2021-10-04", value: 64000 },
        { time: "2021-10-05", value: 63179.71 },
      ];
      const dayData = [
